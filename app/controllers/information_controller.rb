class InformationController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @information.update(information_params)
        format.html { redirect_to "/information/1/edit", notice: "Information was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to information_index_path, status: :see_other, notice: "Information was successfully destroyed." }
  ...
  private
    ...
    def information_params
      params.expect(information: [ :text1, :text2, :text3, :text4, :text5, :text6, :text7, :whatsapp_number, :facebook_link ])
    end
end
